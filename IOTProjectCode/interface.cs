...
namespace Product_Quality_Checker_System
{
    public partial class f : Form
    {
        ...
        private void UpdateData(string data)
        {
            ...
            else if (data.StartsWith("Measured Height:"))
            {
                string heightValue = data.Replace("Measured Height:", "").Replace("cm", "").Trim();
                measuredHeightText.Text = heightValue + " cm";
            }

            else if (data.StartsWith("✔ STATUS: OK"))
                outputTextBox.AppendText("Product dimension is OK\n");
            else if (data.StartsWith("✖ STATUS: MISMATCH"))
                outputTextBox.AppendText("Dimension defect detected!\n");
        }
        ...
        private void savebutton_Click(object sender, EventArgs e)
        {
            ...
            outputTextBox.Clear();
            arduinoPort.WriteLine($"SET_DIMENSIONS,{height}");
        }
        ...
        private void measuredHeightText_TextChanged(object sender, EventArgs e)
        {
